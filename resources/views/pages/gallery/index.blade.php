            ...
            <div class="container">
                <div class="row">
                    ...
                    <!--News One Single-->
                        <div class="news-one__single">
                            <div class="news-one__img">
                                <img src="frontend/assets/images/sawah.jpg" alt="">
                            ...
                            <div class="news-one__content">
                                <h3 class="news-one__title">
                                    <a href="news-details.html">Sawah</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--News One Single-->
                        <div class="news-one__single">
                            <div class="news-one__img">
                                <img src="frontend/assets/images/ngojol.jpg" alt="">
                                {{-- <a href="news-details.html">
                                    <span class="news-one__plus"></span>
                                </a> --}}
                            </div>
                            <div class="news-one__content">
                                <h3 class="news-one__title">
                                    <a href="news-details.html">NGOJOL</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--News One Single-->
                        <div class="news-one__single">
                            <div class="news-one__img">
                                <img src="frontend/assets/images/tokodesaku.jpg" alt="">
                                {{-- <a href="news-details.html">
                                    <span class="news-one__plus"></span>
                                </a> --}}
                            </div>
                            <div class="news-one__content">
                                <h3 class="news-one__title">
                                    <a href="news-details.html">TOKODESAKU</a>
                                </h3>
                            </div>
                        </div>
                    </div>
